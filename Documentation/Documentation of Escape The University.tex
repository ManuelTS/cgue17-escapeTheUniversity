...
\begin{itemize}
	...
	\item Effect Point: Deferred Shading as described in section \ref{Features}.
\end{itemize}
...
\begin{itemize}
  ...
  \item \href{https://www.youtube.com/watch?v=2LW9JSYn_h0}{Radar} frustum culling from a \href{http://www.lighthouse3d.com/tutorials/view-frustum-culling/radar-approach-implementation-ii}{lighthouse3d.com tutorial} and \cite{gems5} with a lot of changes. All objects and lights are tested for culling with a scaled bounding sphere.
  ...
  % Automatic minimal collision shape calculation https://github.com/kmammou/v-hacd and its integration https://kmamou.blogspot.co.at/2014/12/v-hacd-20-in-your-project.html
\end{itemize}
